...
public class CardlessQuickPay0003 {
	private static Logger logger = Logger.getLogger(CardlessQuickPay0003.class);
...
//			filePath = path + "/yl-rsa-签名证书.cer";
	...
	private void createBodyXML(Element root) {
        ...
        RcverAcctId.setText("6224243000000011");
        // 接收方名称
