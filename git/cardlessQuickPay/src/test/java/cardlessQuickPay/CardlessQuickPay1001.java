...
public class CardlessQuickPay1001 {
	private static Logger logger = Logger.getLogger(CardlessQuickPay1001.class);
...
//      String sensInf = "<ExpDt>a022</ExpDt><CvnNo></CvnNo>";
	...
	private void createBodyXML(Element root,Map<String,String> map) {
        ...
        PyerAcctId.setText("6224243900050025");
        // 付款方账户类型
        ...
        SgnNo.setText("UPW0ISS0014936000001049360000W0ISS001201711260000000193");
        // 产品信息
        ...
        OrdrId.setText("4936000041286552910000106755454128655292");
        // 订单详情
