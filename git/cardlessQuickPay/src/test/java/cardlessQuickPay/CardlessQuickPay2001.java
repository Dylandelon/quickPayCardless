...
public class CardlessQuickPay2001 {
	private static Logger logger = Logger.getLogger(CardlessQuickPay2001.class);
...
//			String ValBtMp = SysRtnInf.element("ValBtMp").getText();
	...
	private void createBodyXML(Element root) {
        ...
        PyeeAcctId.setText("6212143000000000011");
        // 收款方账户类型 银联填写
