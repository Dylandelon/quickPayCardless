...
public class CardlessQuickPayRSATest {
	private static Logger logger = Logger.getLogger(CardlessQuickPayRSATest.class);
	private static String path = ClassLoader.getSystemResource("").getPath();
	/**
	 * 协议支付签约触发短信-成功-作为“协议支付”原交易1
	 */
	@Test
...
//      String sensInf = "<ExpDt>a022</ExpDt><CvnNo></CvnNo>";
		...
		String sensInfoEB = null;
		String encKeyEB = null;
		try {
	...
	private void createBodyXML(Element root,Map<String,String> map) {
        ...
        RcverAcctId.setText("6224243900050025");
        // 接收方名称
...
//        SensInf.setText("![CDATA["+map.get("sensInfoEB")+"]]");
        // 发起方信息
