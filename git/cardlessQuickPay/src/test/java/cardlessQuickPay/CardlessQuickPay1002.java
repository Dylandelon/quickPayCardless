...
public class CardlessQuickPay1002 {
	private static Logger logger = Logger.getLogger(CardlessQuickPay1002.class);
...
//			String PyerAcctId = PyerInf.element("PyerAcctId").getText();
	...
	private void createBodyXML(Element root) {
        ...
        PyeeAcctId.setText("00001010001");
        // 收款方名称
