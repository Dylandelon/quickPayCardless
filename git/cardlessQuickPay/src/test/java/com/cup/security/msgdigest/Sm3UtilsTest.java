...
public class Sm3UtilsTest {
	...
	@Test
	/**
	 * 示例数据来源：国家密码管理局 SM3密码杂凑算法
	 */
	public void test() {
		String message = "abc";
		String standardHex = "66c7f0f462eeedd9d1f2d46bdc10e4e24167c4875cf2f7a2297da02b8f4ba8e0";
		
		String res;
		res = Hex.toHexString(Sm3Utils.digest(message.getBytes()));
