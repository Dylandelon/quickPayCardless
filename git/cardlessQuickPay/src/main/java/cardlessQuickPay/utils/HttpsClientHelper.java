package cardlessQuickPay.utils;
...
public class HttpsClientHelper {
	...
	/**
	 * @Description:使用HttpsURLConnection发送post请求
	 * @author:zdl
	...
	public static String sendPost(String urlParam, Map<String, String> params, String charset) {
		...
		// 构建请求参数
		String sbParams = null;
		sbParams = params.get("sendxml");
...
//		OutputStreamWriter osw = null;
		...
		try {
			...
			con.setRequestProperty("MsgTp", params.get("MsgTp"));
			con.setRequestProperty("OriIssrId", "49360000");
			con.setRequestProperty("SderReserved", "000098");
			con.setRequestProperty("Content-Length", sbParams.getBytes().length+"");
			con.setRequestProperty("RcverReserved", "");
			con.setRequestProperty("CupsReserved", "");
			// sb.toString().getBytes().length
//			con.setRequestProperty("Content-Encoding", "gzip");
			con.setRequestProperty("Content-Encoding", "");
...
//				
	 ...
	 */
	public static String sendPost2(String urlParam, Map<String, String> params, String charset) {
		StringBuffer resultBuffer = null;
		// 构建请求参数
		String sbParams = null;
...
//		}
		...
		try {
			...
			con.setReadTimeout(200*1000);
			// 设置通用的请求属性
//			con.setRequestProperty("accept", "*/*");
//			con.setRequestProperty("connection", "Keep-Alive");
			con.setRequestProperty("MsgTp", "0001");
			con.setRequestProperty("OriIssrId", "49360000");
			con.setRequestProperty("SderReserved", "000098");
...
//			con.setRequestProperty("user-agent", "Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1;SV1)");
	...
	/**
	 * @Description:使用HttpsURLConnection发送get请求
	 * @author:zdl
	 * @time:2016年5月17日 下午3:27:29
	 */
