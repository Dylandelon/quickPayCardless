...
public class QuickPay2001 {
	private static String path = ClassLoader.getSystemResource("").getPath();
	/**
	 * 贷记付款-成功
	 */
	public Map<String,String> pay2001(Map<String,String> map) {
		// 从证书中获取 RSA 公私钥
...
//      String sensInf = "<ExpDt>a022</ExpDt><CvnNo></CvnNo>";
	...
	private void createBodyXML(Element root,Map<String,String> map) {
        ...
        PyeeAcctId.setText(map.get("PyeeAcctId"));
        // 收款方账户类型 银联填写
        Element PyeeAcctTp= PyeeInf.addElement("PyeeAcctTp");
        PyeeAcctTp.setText("");
        // 发送机构标识
...
//        PyeeIssrId.setText("49360000");
        ...
        PyeeNm.setText(map.get("PyeeNm"));
        Element IDTp = PyeeInf.addElement("IDTp");
        IDTp.setText(map.get("IDTp"));
        Element IDNo = PyeeInf.addElement("IDNo");
...
//        PyeeAreaNo.setText("1101");
        ...
        // 发送机构标识
//        Element PyerIssrId = PyerInf.addElement("PyerIssrId");
//        PyerIssrId.setText("01020000");
        ...
        PyerAcctIssrId.setText(map.get("PyerAcctIssrId"));
        // 付款方账户
