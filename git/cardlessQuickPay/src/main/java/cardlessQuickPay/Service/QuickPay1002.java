...
public class QuickPay1002 {
	private static String path = ClassLoader.getSystemResource("").getPath();
	/**
	 * 直接支付-成功
	 */
	public Map<String,String> pay1002(Map<String,String> map) {
		// 从证书中获取 RSA 公私钥
...
//      String sensInf = "<ExpDt>a022</ExpDt><CvnNo></CvnNo>";
	...
	private void createBodyXML(Element root,Map<String,String> map) {
        ...
        // 动态验证码
        Element AuthMsg = PyerInf.addElement("AuthMsg");
        AuthMsg.setText(map.get("AuthMsg"));
        // 动态短信关联码
        Element Smskey = PyerInf.addElement("Smskey");
        Smskey.setText(map.get("Smskey"));
        ...
        PyeeAreaNo.setText(map.get("PyeeAreaNo"));
        // 备付金
...
//        SgnNo.setText("UPW0ISS0014936000001049360000W0ISS001201711150000000020");
        // 产品信息
